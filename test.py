...
import soundfile as sf  # Assuming you are using soundfile for reading audio files
import scipy.io.wavfile  # You can remove this import as it's not used in testing
